...
| **User (Test)** | testuser | testuser123 | სატესტო ექაუნთი შესამოწმებლად |
...
* **Battle with Boss** – ინტერაქტიული მათემატიკური თამაში, სადაც ბოსის დასამარცხებლად საჭიროა მაგალითების სწრაფად ამოხსნა.
  > 💡 **როგორ ვითამაშოთ:** თამაშის გასაშვებად საიდბარიდან (Sidebar) გადადით მათემატიკის (Mathematics) გვერდზე, სადაც მარჯვენა ზედა კუთხეში დაგხვდებათ ღილაკი **Battle with Boss**.
